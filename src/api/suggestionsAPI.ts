...
const instance = axios.create({
  ...
  headers: {
    ...
    Authorization: "Token 7720b9ed2ebe39ef79bccbcf07ce101db47cfcab",
  },
});

export const suggestionsAPI = {
  getAutoComplite(city: string, from = "city", to = "settlement") {
    return instance.post<ISuggestionsResponse>("", {
      query: city,
